class MoshpitsUnstable < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/rustyhorde/moshpit/releases/download/v0.9.3/mps-unstable-aarch64-apple-darwin.tar.gz"
      sha256 "24e9810e38bb0e40b0d998696ae5fa0fcab83f94d2ad4560b0758c821a9739a1"
    end
  end
