class MoshpitKeygen < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/rustyhorde/moshpit/releases/download/v0.9.1/mp-keygen-aarch64-apple-darwin.tar.gz"
      sha256 "eb5f378980aa23da97beb79e1c0b96ffb5a3b330efb5b3e029812f2ef023cf03"
    end
  end
