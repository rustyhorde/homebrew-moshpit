class Moshpits < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/rustyhorde/moshpit/releases/download/v0.9.3/mps-aarch64-apple-darwin.tar.gz"
      sha256 "ca6cbe4d8054bd83a59e9f52e49568c91ddb2b47ceb3818915ccefacdafaedba"
    end
  end
